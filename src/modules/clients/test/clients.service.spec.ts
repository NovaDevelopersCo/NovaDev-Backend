...
describe('ClientService', () => {
    ...
    describe('createClient', () => {
        it('should create a client', async () => {
            ...
            const result = await service.createClinet(dto);
    ...
    describe('getAll', () => {
        it('should return an array of clients', async () => {
            ...
            expect(clientRepositoryMock.findAll).toHaveBeenCalledWith({ include: { all: true } });
        });
    });
    ...
    describe('getClientById', () => {
        ...
        it('should throw an error if client not found', async () => {
            ...
            await expect(service.getClientById(3)).rejects.toThrow(HttpException);
        });
    });
