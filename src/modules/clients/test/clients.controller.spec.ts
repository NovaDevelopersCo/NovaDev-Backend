...
describe('ClientController', () => {
    ...
    const mockClientService = {
        ...
        CutClientToProject: jest.fn((projectId: number, clientId: number) =>
            Promise.resolve({ status: 200, message: 'Client removed from project' })
        ),
        deleteClient: jest.fn((id: number) =>
            Promise.resolve({ status: 200, message: 'Client deleted successfully' })
        ),
    ...
    describe('create', () => {
        it('should create a client', async () => {
            ...
            expect(service.createClinet).toHaveBeenCalledWith(dto);
        });
    });
    ...
    describe('getById', () => {
        ...
        it('should throw an error if client not found', async () => {
            jest.spyOn(service, 'getClientById').mockRejectedValueOnce(new Error('Client not found'));
            try {
    ...
    describe('updateProject', () => {
        it('should update a client', async () => {
            const dto: CreateClientDto = { name: 'Updated Max', tg: '@updated', phone: '+798800012123' };
    ...
    describe('addUser', () => {
        it('should add a client to a project', async () => {
            ...
            expect(result).toEqual({ status: 200, message: 'Client added to project' });
            expect(service.addClientToProject).toHaveBeenCalledWith(dto.projectId, dto.clientId);
        });
    });
    ...
    describe('cutUser', () => {
        it('should cut a client from a project', async () => {
            ...
            expect(result).toEqual({ status: 200, message: 'Client removed from project' });
            expect(service.CutClientToProject).toHaveBeenCalledWith(dto.projectId, dto.clientId);
        });
    });
    ...
    describe('deleteProject', () => {
        it('should delete a client', async () => {
            ...
            expect(result).toEqual({ status: 200, message: 'Client deleted successfully' });
